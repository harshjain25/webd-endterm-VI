...
mongoose.connect(
  "mongodb+srv://gofood:9997@cluster0.yytswjp.mongodb.net/?retryWrites=true&w=majority",
  (err) => {
...
//mongoose.connect('mongodb+srv://aNeZki4hhVOV@cluster0.la2i7lg.mongodb.net/?retryWrites=true&w=majority', {
